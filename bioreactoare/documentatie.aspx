...
<body>
    ...
    <header>
        <div class="container">
            ...
            <ul class="nav nav-pills pull-right" id="menu">
              ...
              <li class="active"><a href="documentatie.html">Documentatie</a></li>
    ...
    <div class="container" id="doc-container">
        <div class="row">
            <div class="col-xs-6 col-sm-3 pull-left" id="left-sidebar">
                <div id="left-sidebar-text">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8" id="left-content">
